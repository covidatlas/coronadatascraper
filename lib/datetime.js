...
/*
  Get date formatted in YYYY-MM-DD
*/
...
function scrapeDateIsBefore(date) {
  return dateIsBefore(new Date(process.env['SCRAPE_DATE']), new Date(date));
}

export { getDate, getYYYYMD, getYYYYMMDD, getMDYYYY, getMDYY, getDDMMYYYY, dateIsBefore, scrapeDateIsBefore };
