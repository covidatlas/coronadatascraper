...
const scraper = {
  ...
  sources: [
    {
      name: 'Robert Koch-Institut (RKI), Schleswig-Holstein ministry of health',
      description:
        'RKI, Schleswig-Holstein ministry of health, double-checked with ZEIT ONLINE, curated by JPG, see "curators"',
