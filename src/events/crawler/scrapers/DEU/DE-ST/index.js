...
const scraper = {
  ...
  sources: [
    {
      name: 'Robert Koch-Institut (RKI), Sachsen-Anhalt ministry of health',
      description:
        'RKI, Sachsen-Anhalt ministry of health, double-checked with ZEIT ONLINE, curated by JPG, see "curators"',
