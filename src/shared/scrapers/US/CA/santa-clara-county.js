...
const scraper = {
  ...
  scraper: {
    '0': async function() {
      ...
      const ui = await fetch.json(this, this._urls.report, 'ui', false, {
        headers: {
      ...
      const testUI = await fetch.json(this, this._urls.testingReport, 'testingUI', false, {
        headers: {
          'X-PowerBI-ResourceKey': '9ab407fc-7baa-4543-8f33-4a4cb33505c8'
        }
      });
