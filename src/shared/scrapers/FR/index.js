...
const scraper = {
  ...
  async scraper() {
    ...
    const datasets = await fetch.csv(this, this.url, 'default', false, { delimiter: ';' });
    ...
    let hopitalizedData = await fetch.csv(this, hopitalizedDataset.url, 'default', false, { delimiter: ';' });
    ...
    let testedData = await fetch.csv(this, testedDataset.url, 'default', false, { delimiter: ';' });
