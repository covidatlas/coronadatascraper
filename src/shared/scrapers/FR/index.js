...
const scraper = {
  ...
  async scraper() {
    ...
    const datasets = await fetch.csv(this, this.url, false, { delimiter: ';' });
    ...
    let hopitalizedData = await fetch.csv(this, hopitalizedDataset.url, false, { delimiter: ';' });
    ...
    let testedData = await fetch.csv(this, testedDataset.url, false, { delimiter: ';' });
