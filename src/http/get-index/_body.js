...
<head>
  ...
  <style>
    ...
    .heading {
      font: 900 36px "Open Sans", Helvetica, sans-serif;
      font-weight: bold;
      margin: 0;
...
<body>
  <div id="container">
    <section class="section column-section section-intro">
      <div class="header">
        <div class="logo">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 630.34 118.88">
            <defs>
              <style>
                .cls-1 {
                  fill: #1e0a46;
      ...
      <p class="heading">About the project</p>
      <p class="intro">COVID Atlas provides easy to understand local-level data – including local charts, maps, and insights – related to the COVID-19 pandemic.</p>
      <p class="intro">Our data is sourced exclusively from official public health channels, and verified sources.
      </p>
      <p class="heading">Built by a global community</p>
      <p class="intro">This project is <a href="https://github.com/covidatlas/coronadatascraper/">community-developed, open source</a>, and publishes all data, research, and related findings in the public domain.</p>
      <p class="intro">We're working around the clock to release COVID Atlas; in the mean time, if you're a developer or researcher, you can <a href="https://coronadatascraper.com/data.csv"></a>download our raw local-level dataset</a> or <a href="https://coronadatascraper.com/features.json">view it displayed on a world map</a>.</p>
      <p class="intro">If you'd like to contribute, please <a
          href="https://github.com/covidatlas/coronadatascraper/">send us a PR</a> and join us on <a
          href="https://join.slack.com/t/covid-atlas/shared_invite/zt-d6j8q1lw-C4t00WbmIjoxeHgxn_GDPQ">Slack</a>.
      </p>
      <p class="intro">Please check back for updates!</p>
      <footer class="footer main-text main-text-small">
        ...
        <a class="footer-links link-facebook" href="https://facebook.com/covidatlas"
          target="_blank">Facebook</a>
        <a class="footer-links link-instagram" href="https://instagram.com/covidatlas"
