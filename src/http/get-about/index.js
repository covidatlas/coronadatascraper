...
<div class="spectrum-Site-content">
  ...
  <div class="spectrum-Site-mainContainer spectrum-Typography">
    ...
    <section class="ca-Section">
      ...
      <p class="spectrum-Body spectrum-Body--M">This project is <a class="spectrum-Link" href="https://github.com/covidatlas/">community-developed, open source</a>, and publishes all data, research, and related findings in the public domain.</p>
      ...
      <p class="spectrum-Body spectrum-Body--M">If you'd like to contribute, please <a class="spectrum-Link" href="https://github.com/covidatlas/">send us a PR</a> and join us on <a class="spectrum-Link" href="${
        constants.slackURL
      }">Slack</a>.</p>
